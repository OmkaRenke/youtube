            ...
            <div className="singleVideoPlay">
              ...
              <div className="videoDetails">
                <div className="details">
                  <div className="videoTitle">{selectedVideo?.title}</div>
                    ...
                    {selectedVideo && (
                      <div className="left">
                        ...
                        <div className="nameSubcriberNum">
                          <div className="title">
                            {selectedVideo?.author?.title}
                          </div>
                          <div className="number">
                            {selectedVideo?.author?.stats?.subscribersText}
                          </div>
                        </div>
                        <button
                          className={`subscribebtn ${subscribe ? "sub" : ""} `}
                      ...
                      {selectedVideo && (
                        <>
                          <span className="views">
                            {abbreviateNumber(selectedVideo?.stats?.views, 2)}{" "}
                            views
                          </span>
